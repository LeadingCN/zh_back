...
let TopOrderService = class TopOrderService {
    ...
    async findAll(params, user) {
        ...
        let total = await this.sql.query(`SELECT count(1) AS count,SUM(quota) AS quotatotal FROM ${this.order_talbe} WHERE zh LIKE '%${keyword ? keyword : ''}%' AND is_delete = 0 ${zidsql} ${queryTypesql} ${zhmarksql} ${createsql} ${channelsql} ${merchantidsql} ${uidsql}
      ${this.isAdmin(user)};
      `);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cd0276fb0eae297e7fe4")
/******/ })();
/******/ 
/******/ }
;